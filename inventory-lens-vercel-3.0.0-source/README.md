...
The current release is version 3.2.0. Source and documentation are public at [ListAI67/InventoryLens](https://github.com/ListAI67/InventoryLens) under the MIT License. Browser-store distribution still requires the remaining support, privacy-policy hosting, browser-minimum, screenshot/promotional-asset, and store-account fields identified in the documentation.
